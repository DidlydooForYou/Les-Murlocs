...
BEGIN 
    ...
    IF NOT EXISTS (SELECT 1 FROM statistiques where JoueursJeu_idJoueur = p_idJoueur) THEN
            Insert into statistiques (bonneReponse,mauvaiseReponse,JoueursJeu_idJoueur,	bonneReponseDifficile,questionsDifficile,questionsMoyenne,questionsFacile,reponsesDifficiles,reponsesMoyenne,reponsesFacile) VALUES (0,1,p_idJoueur,0,0,0,0,0,0,0);
    ELSE
